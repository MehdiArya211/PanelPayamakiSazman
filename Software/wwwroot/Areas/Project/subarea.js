...
var subarea = {
    ...
    list: {
        ...
        initial: function () {
            ...
            this.table = $('#datatables').DataTable({
                ...
                ajax: {
                    url: "/Project/SenderNumberSubArea/GetList",
                    type: "POST",
                    dataType: "json"
                },
                ...
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <button onclick="subarea.edit.loadForm('${row.id}')"
                            class="btn btn-light action-btn"
                            title="ویرایش">
                        <i class="bi bi-pencil text-primary"></i>
                    </button>

                    <button onclick="subarea.delete.confirm('${row.id}', '${row.title}')"
                            class="btn btn-light action-btn"
                            title="حذف">
        ...
        reload: function () {
            subarea.list.table.ajax.reload(null, false);
        }
    },
    ...
    create: {
        ...
        loadForm: function () {
            ...
            $.get("/Project/SenderNumberSubArea/LoadCreateForm", function (res) {
    ...
    edit: {
        ...
        loadForm: function (id) {
            ...
            $.get("/Project/SenderNumberSubArea/LoadEditForm", { id: id }, function (res) {
    ...
    delete: {
        ...
        exec: function (id) {
            ...
            $.post("/Project/SenderNumberSubArea/Delete", { id: id })
